...
CCY_PRECISIONS = {'BHD': 3, 'BIF': 0, 'BYR': 0, 'CLF': 4, 'CLP': 0,
                  ...
                  'EUR': 3,
                  # Cryptocurrencies
                  'BTC': 8, 'LTC': 8, 'XRP': 6, 'ETH': 18,'QTC':8,
                  }
...
class CoinGecko(ExchangeBase):
    ...
    async def get_rates(self, ccy):
        json = await self.get_json('api.coingecko.com', '/api/v3/coins/markets?vs_currency=%s&ids=qubitcoin-2&order=market_cap_desc&per_page=100&page=1&sparkline=false&price_change_percentage=1h' % ccy)
